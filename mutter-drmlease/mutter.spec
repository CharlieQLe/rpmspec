...
Name:          mutter
Version:       %{gnome_version}.drmlease
Release:       %autorelease
Summary:       Window and compositing manager based on Clutter

License:       GPLv2+
URL:           http://www.gnome.org
Source0:       http://download.gnome.org/sources/%{name}/%{gnome_major_version}/%{name}-%{tarball_version}.tar.xz
...
Patch: 0001-add-wayland-drm-lease-protocol-support-3746.patch
